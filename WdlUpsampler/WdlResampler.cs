...
namespace NAudio.Dsp {
	...
	public class InputDrivenWdlResamplingSampleProvider : ISampleProvider {
		...
		public InputDrivenWdlResamplingSampleProvider(ISampleProvider source, int newSampleRate) {
			...
			resampler.SetFeedMode(true); // output driven
